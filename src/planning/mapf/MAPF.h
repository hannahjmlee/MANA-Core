...
class MAPF {
    ...
    public:
        ...
        // Constructor with specified cost function, specified roadmap resolution, and optional debug flag
        MAPF(std::string _cost, size_t _resolution, bool _debug = false) :
            m_cost(_cost),
